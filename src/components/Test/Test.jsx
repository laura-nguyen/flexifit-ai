...
const Test = () => {
  ...
  const countReps = (pose) => {
    ...
    const leftShoulder = pose.keypoints.find(
      (point) =>
        point.part === "leftShoulder" && point.score > confidenceThreshold
    );
    const leftElbow = pose.keypoints.find(
      (point) => point.part === "leftElbow" && point.score > confidenceThreshold
    );
    const leftWrist = pose.keypoints.find(
      (point) => point.part === "leftWrist" && point.score > confidenceThreshold
    );
